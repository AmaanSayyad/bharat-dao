      ...
      <div className="section-container">
        <div className="text-center mb-10 sm:mb-16">
          ...
          <h2 className="section-title mb-3 sm:mb-4 opacity-0 fade-in-element">
            Connecting Global Blockchains <br className="hidden sm:block" />with Indian Talent
          </h2>
          <p className="section-subtitle mx-auto opacity-0 fade-in-element">
            Bridging the gap between 1000+ protocols and India's massive developer and user base.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
          <FeatureCard
            ...
            description="Join a vibrant community of builders, educators, content creators, and Web3 enthusiasts driving India's blockchain revolution."
            index={0}
          />
          <FeatureCard
            ...
            description="Access blockchain education and opportunities in local languages through IRL events, AMAs, and community-led engagement across India."
            index={1}
          />
          <FeatureCard
            ...
            description="Join our $10,000+ reward pool and lead the Web3 movement as a Bharat Dao ambassador, with clear paths for growth and recognition."
            index={2}
          />
          <FeatureCard
            ...
            title="$BDAO Token"
            description="Participate in our community token on Solana that powers governance, gated access, and exclusive opportunities within the ecosystem."
            index={3}
          />
          <FeatureCard
            ...
            title="Proposal-Based DAO"
            description="Submit initiatives, vote on proposals, and receive funding through our community-driven governance system that puts power in members' hands."
            index={4}
          />
          <FeatureCard
            ...
            description="Access early tech, job opportunities, grants, bounties, and open work through our connections with global blockchain protocols."
            index={5}
          />
        </div>
      </div>
