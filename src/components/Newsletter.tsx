  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      toast({
        ...
        description: "You'll receive updates about Bharat Dao ($BDAO) soon."
      });
      setEmail("");
  ...
  return <section id="newsletter" className="bg-white py-0">
      <div className="section-container opacity-0 animate-on-scroll">
        <div className="max-w-6xl mx-auto">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col md:flex-row gap-4 items-start md:items-center mb-10">
